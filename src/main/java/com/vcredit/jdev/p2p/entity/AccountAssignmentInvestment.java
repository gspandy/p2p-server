...
//用户项目转让记录
@Entity
@Table(name = "t_act_ass_inv")
public class AccountAssignmentInvestment {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "t_act_ass_inv_seq", unique = true, nullable = false)//用户项目转让记录流水号
	...
	private BigDecimal accountInvestmentQuota;// 转让额度
	...
	@Column(name = "act_inv_eform", nullable = false)	//结清方式	
