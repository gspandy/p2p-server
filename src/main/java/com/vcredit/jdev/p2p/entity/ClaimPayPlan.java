...
//债权还款计划
@Entity
@Table(name="t_clm_pplan")
public class ClaimPayPlan {
	
	
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "t_clm_pplan_seq", unique = true, nullable = false)
	...
	public void setClaimPayPlanJusticeInterest(BigDecimal claimPayPlanJusticeInterest) {
