...
@Entity
@Table(name = "t_act_ass_order")//用户项目转让订单
public class AccountAssignmentOrder {
	@Id 
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "t_act_ass_order_seq", unique = true, nullable = false)
	private Long accountAssignmentOrderSequence;// 流水号
	...
	@Column(name = "trade_desc",length=60)	//交易描述	
